...
describe('list-pods', () => {
  ...
  it('should throw on status 400', async () => {
    ...
    await expect(
      ...
      'message',
      'OS API returned status code 400 for <url>'
    )
  })
  ...
  it('should throw on status 204', async () => {
    ...
    await expect(
      ...
      'message',
      'OS API returned status code 204 for <url>'
    )
  })
  ...
  it('should throw when result is not a podlist', async () => {
    ...
    await expect(
      ...
      'message',
      'Expected OS API to return a PodList but got undefined'
    )
  })
  ...
  it('should throw when result is not an object', async () => {
    ...
    await expect(
      ...
      'message',
      'Expected OS API to return an object but got string'
    )
  })
  ...
  it('should throw when result is null', async () => {
    ...
    await expect(
      ...
      'message',
      'Expected OS API to return an object but got null'
    )
  })
  ...
  it('should throw when result is an array', async () => {
    ...
    await expect(
      ...
      'message',
      'Expected OS API to return an object but got an array'
    )
  })
})
