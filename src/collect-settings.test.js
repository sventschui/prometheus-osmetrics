...
describe('collect-settings', () => {
  it('should throw if OS_API is missing', async () => {
    await expect(collectSettings({})).rejects.toHaveProperty(
      'message',
  ...
  it('should throw if OS_METRIC_API is missing', async () => {
    await expect(collectSettings({ OS_API: 'foo' })).rejects.toHaveProperty(
      'message',
  ...
  it('should throw if OS_ACCESS_TOKEN is missing', async () => {
    await expect(
      collectSettings({ OS_API: 'foo', OS_METRIC_API: 'bar' })
